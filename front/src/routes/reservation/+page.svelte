...
<div class="container">
    ...
    <form>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="numberPers" bind:value={$reservation.needPlace} />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" class="form-control" id="dateEnd" bind:value={$reservation.dateEnd} />
        </div>
